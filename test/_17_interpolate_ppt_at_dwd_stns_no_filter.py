            ...
            for stn_dwd_id in stn_comb:
                ...
                if (isinstance(vgs_model_dwd_ppt, str)) and (
                    ...
                    if netatmo_df.size > 0:
                        ...
                        # event
                        ppt_netatmo_vals = netatmo_df.values
                    ...
                    if netatmo_df.size == 0:
                        print('no netadmo data')
                        ppt_netatmo_vals = np.nan
                        netatmo_xcoords = np.nan
                        netatmo_ycoords = np.nan

                    if any(netatmo_xcoords) > 0:
                        # add vals to DWD

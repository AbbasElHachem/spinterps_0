...
path_to_netatmo_gd_stns = (main_dir /
                           r"\ppt_cross_valid_BW_60min\ppt_all_netatmo_100_intense_events_corrected_99_60min.csv")
# for second filter
...
netatmo_in_ppt_vals_df_gd_corr.to_csv(out_plots_path / (
    'ppt_all_netatmo_100_intense_events_corrected_99_%s.csv'

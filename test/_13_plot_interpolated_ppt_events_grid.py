...
# , '360min', '720min']  # ,'1440min'] #'60min',
resample_frequencies = ['1440min']

# '120min', '180min',
title_ = r'Ppt_ok_plots'
...
def plot_interp_ppt_evnt(vals_to_plot, str_title,
    ...
    plt.colorbar(cmap=cmap,
                 norm=norm,
                 ticks=bound, label='Rainfall Value')
...
for temp_agg in resample_frequencies:
    ...
    for event_date in dwd_in_extremes_df.index:
        ...
        if (isinstance(vgs_model_dwd_ppt, str)) and (
            ...
            interpolated_vals_dwd_netatmo_un = ordinary_kriging_dwd_netatmo_ppt_unc.zk.copy()
            ...
            interpolated_vals_dwd_netatmo_un[
                interpolated_vals_dwd_netatmo_un < 0] = 0
